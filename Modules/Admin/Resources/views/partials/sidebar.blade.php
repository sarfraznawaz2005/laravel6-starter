...
<aside class="app-sidebar animated bounceInLeft">
    <ul class="app-menu">
        <li>
            <a class="app-menu__item {{active_link('admin.panel')}}" href="{{route('admin.panel')}}">
        ...
        <li>
            <a class="app-menu__item {{active_link('admin.users.index')}}" href="{{route('admin.users.index')}}">
        ...
        <li class="treeview {{active_link('admin.panel', 'is-expanded')}}">
